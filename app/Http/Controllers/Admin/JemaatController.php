...
class JemaatController extends Controller
{
   ...
   public function store(Request $request){
      ...
      if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/jemaat')->with('success', 'Berhasil Ditambahkan');            
      }else{
            return redirect('sek/jemaat/jemaat')->with('success', 'Berhasil Ditambahkan');            
      }
   }
   ...
   public function update(Request $request, $id){      
      ...
      $jemaat->update();
        ...
        if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/jemaat')->with('update', 'Berhasil Diedit');            
        }else{
            return redirect('sek/jemaat/jemaat')->with('update', 'Berhasil Diedit');            
        }
   }
   ...
   public function destroy($id){
      ...
      if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/jemaat')->with('sdelete', 'Berhasil Dihapus');            
      }else{
            return redirect('sek/jemaat/jemaat')->with('sdelete', 'Berhasil Dihapus');            
      }
   }
}
