...
class KeluargaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/keluarga')->with('success', 'Berhasil Ditambahkan');            
        }else{
            return redirect('sek/jemaat/keluarga')->with('success', 'Berhasil Ditambahkan');            
        }
    }
    ...
    {        
        ...
        if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/keluarga')->with('update', 'Berhasil Diedit');            
        }else{
            return redirect('sek/jemaat/keluarga')->with('update', 'Berhasil Diedit');            
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if (Auth::user()->hasRole('admin')) {
            return redirect('admin/jemaat/keluarga')->with('sdelete', 'Berhasil Dihapus');            
        }else{
            return redirect('sek/jemaat/keluarga')->with('sdelete', 'Berhasil Dihapus');            
        }
    }
}
