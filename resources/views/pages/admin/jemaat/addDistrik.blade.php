              ...
              <div class="content">
                     ...
                     <div class="card">
                         ...
                         <div class="card-body border-top">
                            @if ($sek->id)
                            <form action="{{route('distrik.update', $sek->id)}}" method="POST">
                                   @csrf
                                   @method('PATCH')
                                   <div class="mb-3">
                                        <label class="form-label">Nama</label>
                                        <input type="text" value="{{$sek->nama}}" class="form-control" name="nama" placeholder="Nama Sektor">
                                   </div>
                                   
                                   <div class="mb-3">
                                        <label class="form-label">Lokasi</label>
                                        <input type="text" class="form-control" value="{{$sek->lokasi}}" name="lokasi" placeholder="Lokasi Sektor">
                                   </div>

                                   <div class="mb-3">
                                          <label class="col-form-label col-lg-3">Penatua</label>
                                          <div class="form-control-feedback">
                                               <select name="penatua" class="form-control select">
                            ...
                            <form action="{{route('distrik.store')}}" method="POST">
                                 ...
                                 <div class="mb-3">
                                      <label class="form-label">Nama</label>
                                      <input type="text" class="form-control" name="nama" placeholder="Nama Sektor">
                                 </div>

                                 <div class="mb-3">
                                      <label class="form-label">Lokasi</label>
                                      <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Sektor">
                                 </div>
                                 <div class="text-end">
