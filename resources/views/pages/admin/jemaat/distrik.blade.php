							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<form action="{{route('distrik.destroy', $item->id)}}" method="POST">
											@csrf
											@method('DELETE')
											<a type="button" method="GET" href="{{route('distrik.edit', $item->id)}}" data-bs-popup="tooltip" title="Edit" class="btn btn-warning btn-icon" style="margin-bottom: -1rem">
