									...
									<td class="text-center">
										<div class="d-inline-flex ">
											<form action="{{route('keuangan.destroy', $m->id)}}" method="POST">
												@csrf
												@method('DELETE')
												<a type="button" method="GET" href="{{route('keuangan.edit', $m->id)}}" data-bs-popup="tooltip" title="Edit" class="btn btn-warning btn-icon" style="margin-bottom: -1rem">
									...
									<td class="text-center">
										<div class="d-inline-flex ">
											<form action="{{route('keuangan.destroy', $k->id)}}" method="POST">
												@csrf
												@method('DELETE')
												<a type="button" method="GET" href="{{route('keuangan.edit', $k->id)}}" data-bs-popup="tooltip" title="Edit" class="btn btn-warning btn-icon" style="margin-bottom: -1rem">
													<i class="ph-note-pencil"></i>
												</a>
