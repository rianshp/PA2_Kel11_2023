              ...
              <div class="content">
                     ...
                     <div class="card">
                         ...
                         <div class="card-body border-top">                             
                             <form action="{{route('malua.update', $m->id)}}" method="POST">
                              @csrf
                              @method('PATCH')
                              <div class="mb-3">
                                   <label class="form-label">Nomor Surat </label>
                                   <input type="text" value="{{$m->no_surat}}" name="no_surat" class="form-control" placeholder="Nama">
                              </div>
                              <div class="mb-3">
                                   <label class="col-form-label col-lg-3">Nama</label>
                                   <div class="form-control-feedback">
                                        <select name="id_user_jemaat" class="form-control select">
                              ...
                              <div class="mb-3">
                                   ...
                                   <div class="form-control-feedback">
                                        <select name="nats" class="form-control select">
                              ...
                              <div class="mb-3">
                                   ...
                                   <input type="date" name="tanggal_sidi" value="{{$m->tanggal_sidi}}" class="form-control" placeholder="">
                              </div> 
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                   ...
                                   <input type="date" name="tanggal_baptis" value="{{$m->tanggal_baptis}}" class="form-control" placeholder="">
                              </div>
                              <div class="text-end">
