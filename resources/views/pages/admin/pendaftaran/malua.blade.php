						...
						<table class="table datatable-fixed-right">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-capitalize">{{$item->tanggal_sidi}}</td>									
									...
									<td class="text-center">
										<div class="d-inline-flex ">
											<form action="{{route('malua.destroy', $item->id)}}" method="POST">
												@csrf
												@method('DELETE')
												<a type="button" method="GET" href="{{route('malua.edit', $item->id)}}" data-bs-popup="tooltip" title="Edit" class="btn btn-warning btn-icon" style="margin-bottom: -1rem">
