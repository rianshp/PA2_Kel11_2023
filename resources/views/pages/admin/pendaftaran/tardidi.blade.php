								...
								<tr>
									...
									<td class="text-center">
										<div class="d-inline-flex ">
											<form action="{{route('tardidi.destroy', $item->id)}}" method="POST">
												@csrf
												@method('DELETE')
												<a type="button" method="GET" href="{{route('tardidi.edit', $item->id)}}" data-bs-popup="tooltip" title="Edit" class="btn btn-warning btn-icon" style="margin-bottom: -1rem">
