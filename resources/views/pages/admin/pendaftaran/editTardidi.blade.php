              ...
              <div class="content">
                     ...
                     <div class="card">
                         ...
                         <div class="card-body border-top">                             
                             <form action="{{route('tardidi.update', $t->id)}}" method="POST">
                              @csrf
                              @method('PATCH')
                              <div class="mb-3">
                                   <label class="form-label">Nomor Surat </label>
                                   <input type="text" value="{{$t->no_surat}}" name="no_surat" class="form-control" placeholder="Nama">
                              </div>
                              <div class="mb-3">
                                   <label class="form-label">Nama </label>
                                   <input type="text" value="{{$t->nama}}" name="nama" class="form-control" placeholder="Nama">
                              </div>                            

                              <div class="mb-3">
                                   <label class="form-label">Nama Ayah </label>
                                   <input type="text" value="{{$t->ayah}}" name="ayah" class="form-control" placeholder="Tempat Lahir">
                              </div>
                              <div class="mb-3">
                                   <label class="form-label">Nama Ibu </label>
                                   <input type="text" value="{{$t->ibu}}" name="ibu" class="form-control" placeholder="Tempat Lahir">
                              </div>
                              <div class="mb-3">                                   
                                   <div class="mb-3">
                                        <label class="col-form-label col-lg-3">Sektor</label>
                                        <div class="form-control-feedback">
                                             <select class="form-control select" aria-label="Default select example" name="id_sektor" id="country" required>
                              ...
                              <div class="mb-3">
                                   ...
                                   <div class="form-control-feedback">
                                        <select name="pendeta" class="form-control select">
                              ...
                              <div class="mb-3">
                                   ...
                                   <div class="form-control-feedback">
                                        <select name="guru_jemaat" class="form-control select">
                              ...
                              <div class="mb-3">
                                   ...
                                   <input type="date" name="tanggal_baptis" value="{{$t->baptis}}" class="form-control" placeholder="">
                              </div>
                              <div class="text-end">
