...
@section('title', 'About')
@section('content')
<section class="wrapper bg-gray pt-14">
     ...
     <!-- /.container -->
     <figure class="position-absoute" style="bottom: 0; left: 0; z-index: 2;"><img src="{{asset('assets/img/photos/bg12.jpg')}}" alt="" /></figure>
   </section>
   <!-- /section -->
     ...
     <div class="container py-14 py-md-16">
       ...
       <div class="row mb-5">
         <div class="col-md-10 col-xl-8 col-xxl-7 mx-auto text-center">
           ...
           <h2 class="display-4 mb-4 px-lg-14">Visi dan Misi</h2>
         </div>
         <!-- /column -->
       </div>
       <!-- /.row -->
     ...
     <div class="container py-14 py-md-16">
       <div class="row mb-3">
         <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
           ...
           <h2 class="display-4 mb-3 px-lg-14">Struktur Organisasi</h2>
         </div>
         <!--/column -->
       </div>
       <!--/.row -->
     ...
     <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
       <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
         ...
         <div class="col-lg-6">
           ...
           <h2 class="display-4 mb-8">Informasi Kontak</h2>
           <div class="d-flex flex-row">
             <div>
           ...
           <div class="d-flex flex-row">
             ...
             <div>
               ...
               <p class="mb-0"><a href="cdn-cgi/l/email-protection.html#b6c5d7d8d2d4d9cef6d3dbd7dfda98d5d9db" class="link-body"><span class="__cf_email__" data-cfemail="e497858a80868b9ca48189858d88ca878b89">[email&#160;protected]</span></a></p>
             </div>
           </div>
         </div>
         <!--/column -->
