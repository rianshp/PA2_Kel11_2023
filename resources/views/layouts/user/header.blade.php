               ...
               <ul class="navbar-nav">
                 ...
                 <li class="nav-item dropdown">
                   ...
                   <ul class="dropdown-menu">
                     ...
                     <li class="nav-item"><a class="dropdown-item" href="{{route('malua.create')}}">Malua/Sidi</a></li>
                     <li class="nav-item"><a class="dropdown-item" href="{{route('menikah.create')}}">Menikah</a></li>
