...
const ExtendedFormControls = (function () {
    ...
    const _componentMaskInput = function () {
        ...
        // Product key
        const maskProductKeyElement =
            document.querySelector("#mask_product_key");
    ...
    const _componentAutosize = function () {
        ...
        const manualElementTrigger = document.querySelector(
            ".elastic-manual-trigger"
        );
        ...
        const eventsElementTrigger = document.querySelector(
            ".elastic-events-trigger"
        );
        ...
        // Destroy method
        const destroyAutosize = autosize(
            document.querySelector(".elastic-destroy")
        );
        document
            .querySelector(".elastic-destroy-trigger")
    ...
    const _componentPassy = function () {
        ...
        const feedbackText = [
            {
                text: '<i class="ph-check me-1"></i> Your password is weak',
                color: "text-danger",
            },
            {
                text: '<i class="ph-check me-1"></i> Your password is normal',
                color: "text-secondary",
            },
            {
                text: '<i class="ph-shield-check me-1"></i> Your password is good',
                color: "text-primary",
            },
            {
                text: '<i class="ph-shield-check me-1"></i> Your password is strong',
                color: "text-success",
            },
        ];
        const feedbackLabel = [
        ...
        const feedbackGroup = [
            ...
            {
                color: "bg-secondary border-secondary text-white",
                text: "Normal",
            },
    ...
    const _componentMaxlength = function () {
        ...
        $(".maxlength-badge-position").maxlength({
            ...
            warningClass:
                "text-success left-auto right-0 top-50 translate-middle-y pe-2 mr-1",
            limitReachedClass:
                "text-danger left-auto right-0 top-50 translate-middle-y pe-2 mr-1",
            placement:
                document.dir == "rtl" ? "centered-left" : "centered-right",
        });
    };
